...
exports.dashboard = async (req, res) => {
  try {
    const [totalUsers, totalInstitutes, pendingInstitutes, totalReviews, totalEnquiries] = await Promise.all([
      User.countDocuments(),
    ...
    res.json({ success: true, stats: { totalUsers, totalInstitutes, pendingInstitutes, totalReviews, totalEnquiries } });
  } catch (err) {
